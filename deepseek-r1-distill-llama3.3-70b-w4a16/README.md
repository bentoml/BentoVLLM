<div align="center">
    <h1 align="center">Self-host DeepSeek R1 Distill Llama 3.3 70B w4a16 GPTQ with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy DeepSeek R1 Distill Llama 3.3 70B w4a16 GPTQ using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
cd BentoVLLM/deepseek-r1-distill-llama3.3-70b-w4a16
