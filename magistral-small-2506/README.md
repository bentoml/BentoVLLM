<div align="center">
    <h1 align="center">Self-host Magistral 3.1 24B 2506 Reasoning Model with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the Magistral 3.1 24B 2506 Reasoning Model model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
...
## Prerequisites
- You have gained access to `mistralai/Magistral-Small-2506` on [Hugging Face](https://huggingface.co/mistralai/Magistral-Small-2506).
...
cd BentoVLLM/magistral-small-2506
