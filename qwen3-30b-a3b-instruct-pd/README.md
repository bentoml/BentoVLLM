<div align="center">
    <h1 align="center">Self-host Qwen3 30B A3B Instruct with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the Qwen3 30B A3B Instruct with BentoCloud in your own cloud account in prefill/decode disaggregation mode. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
...
## Prerequisites
- You have gained access to `Qwen/Qwen3-30B-A3B-Instruct-2507-FP8` on [Hugging Face](https://huggingface.co/Qwen/Qwen3-30B-A3B-Instruct-2507-FP8).
- If you want to test the Service locally, we recommend you use 8 Nvidia GPU with at least 80GB VRAM (e.g. about 8 H100 GPU).

## Install dependencies

```bash
git clone https://github.com/bentoml/BentoVLLM.git
cd BentoVLLM/qwen3-30b-a3b-instruct-pd
...
bentoml deploy service:router --secret huggingface
```
