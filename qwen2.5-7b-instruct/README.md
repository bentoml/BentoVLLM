<div align="center">
    <h1 align="center">Self-host Qwen 2.5 7B Instruct with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the Qwen 2.5 7B Instruct model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
...
cd BentoVLLM/qwen2.5-7b-instruct
