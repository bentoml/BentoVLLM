<div align="center">
    <h1 align="center">Self-host Mistral Large 123B Instruct 2411 with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy Mistral Large 123B Instruct 2411 using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
## Prerequisites
- You have gained access to `mistralai/Mistral-Large-Instruct-2411` on [Hugging Face](https://huggingface.co/mistralai/Mistral-Large-Instruct-2411).
...
cd BentoVLLM/mistral-large-123b-instruct-2411
