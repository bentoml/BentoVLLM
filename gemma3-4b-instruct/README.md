<div align="center">
    <h1 align="center">Self-host Gemma 3 4B Instruct with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy Gemma 3 4B Instruct using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
## Prerequisites
- You have gained access to `google/gemma-3-4b-it` on [Hugging Face](https://huggingface.co/google/gemma-3-4b-it).
...
cd BentoVLLM/gemma3-4b-instruct
