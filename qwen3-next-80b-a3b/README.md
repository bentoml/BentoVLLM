<div align="center">
    <h1 align="center">Self-host Qwen 3 Next 80B A3B MoE with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the Qwen 3 Next 80B A3B MoE model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
...
## Prerequisites
- If you want to test the Service locally, we recommend you use Nvidia GPU with at least 80GBx4 VRAM (e.g about 4 H100 GPUs or 2 H200 GPU).

## Install dependencies

```bash
git clone https://github.com/bentoml/BentoVLLM.git
cd BentoVLLM/qwen3-next-80b-a3b
