...
This is a BentoML example project, showing you how to serve and deploy DeepSeek R1 Distill Qwen 2.5 Math 7B using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
