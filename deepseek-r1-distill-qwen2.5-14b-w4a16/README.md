<div align="center">
    <h1 align="center">Self-host DeepSeek R1 Distill Qwen 2.5 14B w4a16 GPTQ with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy DeepSeek R1 Distill Qwen 2.5 14B w4a16 GPTQ using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
cd BentoVLLM/deepseek-r1-distill-qwen2.5-14b-w4a16
