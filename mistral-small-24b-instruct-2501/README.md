<div align="center">
    <h1 align="center">Self-host Mistral Small 24B Instruct 2501 with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the Mistral Small 24B Instruct 2501 model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
...
## Prerequisites
- You have gained access to `mistralai/Mistral-Small-24B-Instruct-2501` on [Hugging Face](https://huggingface.co/mistralai/Mistral-Small-24B-Instruct-2501).
...
cd BentoVLLM/mistral-small-24b-instruct-2501
