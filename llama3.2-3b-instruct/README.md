...
This is a BentoML example project, showing you how to serve and deploy Llama 3.1 3B Instruct using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
