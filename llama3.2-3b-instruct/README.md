<div align="center">
    <h1 align="center">Self-host Llama 3.1 3B Instruct with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the Llama 3.1 3B Instruct model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
...
## Prerequisites
- You have gained access to `meta-llama/Llama-3.2-3B-Instruct` on [Hugging Face](https://huggingface.co/meta-llama/Llama-3.2-3B-Instruct).
- If you want to test the Service locally, we recommend you use an Nvidia GPU with at least 16GB VRAM (e.g about 1 T4 GPU).

## Install dependencies

```bash
git clone https://github.com/bentoml/BentoVLLM.git
cd BentoVLLM/llama3.2-3b-instruct
