<div align="center">
    <h1 align="center">Self-host Jamba 1.6 Large with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the Jamba 1.6 Large model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
...
## Prerequisites
- You have gained access to `ai21labs/AI21-Jamba-Large-1.6` on [Hugging Face](https://huggingface.co/ai21labs/AI21-Jamba-Large-1.6).
