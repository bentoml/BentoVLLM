<div align="center">
    <h1 align="center">Self-host google/gemma-2-27b-it with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy google/gemma-2-27b-it using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
- You have gained access to google/gemma-2-27b-it on [Hugging Face](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.3).
