...
This is a BentoML example project, showing you how to serve and deploy Gemma 2 27B Instruct using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
