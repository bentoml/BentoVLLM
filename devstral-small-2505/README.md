<div align="center">
    <h1 align="center">Self-host Devstral Small 2505 with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the Devstral Small 2505 model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
...
## Prerequisites
- You have gained access to `mistralai/Devstral-Small-2505` on [Hugging Face](https://huggingface.co/mistralai/Devstral-Small-2505).
...
cd BentoVLLM/devstral-small-2505
