...
- You have gained access to meta-llama/Llama-3.2-90B-Vision-Instruct on [Hugging Face](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.3).
...
cd BentoVLLM/llama3.2-90b-vision
