<div align="center">
    <h1 align="center">Self-host Llama 3.2 90B Vision Instruct with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy Llama 3.2 90B Vision Instruct using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
