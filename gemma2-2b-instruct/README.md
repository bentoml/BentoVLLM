<div align="center">
    <h1 align="center">Self-host Gemma 2 2B Instruct with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the Gemma 2 2B Instruct model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
...
## Prerequisites
- You have gained access to `google/gemma-2-2b-it` on [Hugging Face](https://huggingface.co/google/gemma-2-2b-it).
