<div align="center">
    <h1 align="center">Self-host meta-llama/Llama-3.3-70B-Instruct with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy meta-llama/Llama-3.3-70B-Instruct using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
- You have gained access to meta-llama/Llama-3.3-70B-Instruct on [Hugging Face](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.3).
