<div align="center">
    <h1 align="center">Self-host DeepSeek R1 Distill Llama 3.1 8B Tool Calling with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the DeepSeek R1 Distill Llama 3.1 8B Tool Calling model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
