...
This is a BentoML example project, showing you how to serve and deploy DeepSeek R1 Distill Llama 3.1 8B Tool Calling using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
