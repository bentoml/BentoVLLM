...
import logging, json, os, typing, contextlib, httpx
...
class BentoArgs(pydantic.BaseModel):
  ...
  name: str = 'deepseek-v2-lite-chat-pd'
  ...
  def additional_labels(self) -> dict[str, str]:
    default = {'hf_generation_config': json.dumps(self.hf_generation_config), 'tool': self.tool_parser or ''}
