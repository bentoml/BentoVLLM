<div align="center">
    <h1 align="center">Self-host Llama 3.1 8B Instruct with CPU KV offloading with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the Llama 3.1 8B Instruct with CPU KV offloading model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
...
cd BentoVLLM/llama3.1-8b-kv-offloading
