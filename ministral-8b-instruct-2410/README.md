<div align="center">
    <h1 align="center">Self-host mistralai/Ministral-8B-Instruct-2410 with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy mistralai/Ministral-8B-Instruct-2410 using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
- You have gained access to mistralai/Ministral-8B-Instruct-2410 on [Hugging Face](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.3).
...
cd BentoVLLM/ministral-8b-instruct-2410
