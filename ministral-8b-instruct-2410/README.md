...
This is a BentoML example project, showing you how to serve and deploy Ministral 8B Instruct 2410 using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
