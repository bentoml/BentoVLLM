<div align="center">
    <h1 align="center">Self-host Pixtral Large Instruct 2411 with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy Pixtral Large Instruct 2411 using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
## Prerequisites
- You have gained access to `mistralai/Pixtral-Large-Instruct-2411` on [Hugging Face](https://huggingface.co/mistralai/Pixtral-Large-Instruct-2411).
...
cd BentoVLLM/pixtral-large-2411
...
> [!NOTE]
> This ships with a default `max_model_len=16384`. If you wish to change this value, set `MAX_MODEL_LEN=<target_context_len>`. Make sure that you have enough VRAM to use this context length. BentoVLLM will only set a conservative value based on this model configuration.
