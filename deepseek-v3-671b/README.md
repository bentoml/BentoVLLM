...
This is a BentoML example project, showing you how to serve and deploy DeepSeek V3 671B using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
- If you want to test the Service locally, we recommend you use Nvidia GPUs with at least 80Gx16 VRAM (e.g. about eight H200 GPUs).
