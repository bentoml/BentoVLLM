<div align="center">
    <h1 align="center">Self-host Hermes 3 70B with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy Hermes 3 70B (in GGUF format) using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
cd BentoVLLM/hermes-3-70b-gguf
...
chat_completion = client.chat.completions.create(
    model="NousResearch/Hermes-3-Llama-3.1-70B-GGUF",
    messages=[
        {
            "role": "user",
