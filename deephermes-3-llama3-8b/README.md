<div align="center">
    <h1 align="center">Self-host DeepHermes 3 Llama 3 8B with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy DeepHermes 3 Llama 3 8B using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
cd BentoVLLM/deephermes-3-llama3-8b
