<div align="center">
    <h1 align="center">Self-host Llama 3.1 Tulu-3.1 8B with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy Llama 3.1 Tulu-3.1 8B using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
cd BentoVLLM/llama3.1-tulu-3.1-8b
