<div align="center">
    <h1 align="center">Self-host ai21labs/AI21-Jamba-1.5-Mini with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy ai21labs/AI21-Jamba-1.5-Mini using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
- You have gained access to ai21labs/AI21-Jamba-1.5-Mini on [Hugging Face](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.3).
