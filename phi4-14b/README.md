...
This is a BentoML example project, showing you how to serve and deploy Phi 4 14B using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
