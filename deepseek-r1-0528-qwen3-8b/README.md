<div align="center">
    <h1 align="center">Self-host DeepSeek R1 0528 Qwen3 8B with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the DeepSeek R1 0528 Qwen3 8B model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
...
## Prerequisites
- You have gained access to `deepseek-ai/DeepSeek-R1-0528-Qwen3-8B` on [Hugging Face](https://huggingface.co/deepseek-ai/DeepSeek-R1-0528-Qwen3-8B).
- If you want to test the Service locally, we recommend you use 1 Nvidia GPU with at least 80GB VRAM (e.g. about 1 H100 GPU).

## Install dependencies

```bash
git clone https://github.com/bentoml/BentoVLLM.git
cd BentoVLLM/deepseek-r1-0528-qwen3-8b
