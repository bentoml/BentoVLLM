<div align="center">
    <h1 align="center">Self-host GPT OSS MoE 120B with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the GPT OSS MoE 120B model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
