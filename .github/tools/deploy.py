...
def deploy_bento(bento_tag: str, context: str, progress: Progress, task_id: TaskID) -> DeployResult:
  ...
  try:
    ...
    while True:
      ...
      if status == 'running':
        ...
        return DeployResult(
          bento_tag, False, '[red]Deployment terminated unexpectedly while waiting for running state[/]'
        )
