<div align="center">
    <h1 align="center">Self-host DeepSeek Prover V2 7B with vLLM and BentoML</h1>
</div>

Follow this guide to self-host the DeepSeek Prover V2 7B model with BentoCloud in your own cloud account. If your team doesn’t already have access to BentoCloud, please use the link below to contact us and set it up in your cloud environment.
...
## Prerequisites
- You have gained access to `deepseek-ai/DeepSeek-Prover-V2-7B` on [Hugging Face](https://huggingface.co/deepseek-ai/DeepSeek-Prover-V2-7B).
...
cd BentoVLLM/deepseek-prover-v2-7b
