<div align="center">
    <h1 align="center">Self-host Qwen/Qwen2.5-32B-Instruct with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy Qwen/Qwen2.5-32B-Instruct using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
- You have gained access to Qwen/Qwen2.5-32B-Instruct on [Hugging Face](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.3).
...
cd BentoVLLM/qwen2.5-32b-instruct
