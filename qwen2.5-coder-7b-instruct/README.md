<div align="center">
    <h1 align="center">Self-host Qwen 2.5 Coder 7B Instruct with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy Qwen 2.5 Coder 7B Instruct using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
