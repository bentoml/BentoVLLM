...
import json, logging, contextlib, traceback, typing
...
@bentoml.service(
  ...
  labels={
    ...
    'project': 'bentovllm',
    'openai_endpoint': '/v1',
    'hf_generation_config': '{"temperature": 0.6, "top_p": 0.9, "repetition_penalty": 1.0, "frequency_penalty": 0.2, "max_tokens": 4096}',
    'reasoning': '1',
    'tool': '',
  },
