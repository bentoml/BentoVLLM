<div align="center">
    <h1 align="center">Self-host DeepSeek R1 Distill Llama 3.3 70B with vLLM and BentoML</h1>
</div>

This is a BentoML example project, showing you how to serve and deploy DeepSeek R1 Distill Llama 3.3 70B using [vLLM](https://vllm.ai), a high-throughput and memory-efficient inference engine.
...
## Prerequisites
- You have gained access to `deepseek-ai/DeepSeek-R1-Distill-Llama-70B` on [Hugging Face](https://huggingface.co/deepseek-ai/DeepSeek-R1-Distill-Llama-70B).
- If you want to test the Service locally, we recommend you use Nvidia GPUs with at least 80Gx2 VRAM.

## Install dependencies

```bash
git clone https://github.com/bentoml/BentoVLLM.git
cd BentoVLLM/deepseek-r1-distill-llama3.3-70b
